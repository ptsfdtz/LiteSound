const common = {
  ...
  'settings.neteaseSection': 'Netease Cloud',
  'settings.neteaseEnabled': 'Enabled',
  'settings.neteaseApiPlaceholder': 'Netease API base URL (e.g. http://127.0.0.1:3000)',
  'settings.neteaseCookiePlaceholder': 'Netease cookie (MUSIC_U, etc.)',
  'settings.neteaseHint':
    'Cloud tracks are merged into the library when enabled. Start NeteaseCloudMusicApi first.',
  ...
  'status.updatingNetease': 'Updating Netease config...',
  'status.failedUpdateNetease': 'Failed to update Netease config.',
