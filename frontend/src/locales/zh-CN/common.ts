const common = {
  ...
  'settings.neteaseSection': '网易云云盘',
  'settings.neteaseEnabled': '启用',
  'settings.neteaseApiPlaceholder': '网易云 API 地址（例如 http://127.0.0.1:3000）',
  'settings.neteaseCookiePlaceholder': '网易云 Cookie（MUSIC_U 等）',
  'settings.neteaseHint': '启用后会将云盘歌曲并入列表；请先启动 NeteaseCloudMusicApi 服务。',
  'window.minimise': '最小化',
  'window.maximise': '最大化',
  'window.close': '关闭',
  ...
  'status.updatingNetease': '更新网易云配置...',
  'status.failedUpdateNetease': '更新网易云配置失败。',
