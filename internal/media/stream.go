...
func StartStreamServer(musicDirs func() ([]string, error)) (*StreamServer, error) {
	mux := http.NewServeMux()
	s := &StreamServer{musicDirs: musicDirs}
